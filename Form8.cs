...
namespace GAMECHARACTER01
{
    public partial class Form8 : Form
    {
        ...
        public Form8()
        {
            ...
            this.FormClosing += Form8_FormClosing; // Added FormClosing event handler
        }
        ...
        private void Form8_Load(object sender, EventArgs e)
        {
            if (!isFormLoaded)
            {
                ...
                // Initialize the Mage object
                mage = new Mage("Gaara", 1, 100, 50, 15);

                // Only append ToString once during form load
                string mageStats = mage.ToString();
                richTextBox1.AppendText(mageStats + "\n");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string attackMessage = $"{mage.Name} casts a spell and deals {finalDamage} magic damage" +
                                   (burningEffect ? ", applying a grounded effect!" : ".");
        ...
        {
            // Implement any necessary actions for enemy idle (if needed)
        }

        private void pictureBox2_Click(object sender, EventArgs e)
        {
            // Implement any necessary actions for enemy hurt (if needed)
        }

        private void pictureBox3_Click(object sender, EventArgs e)
        {
            // Implement any necessary actions for enemy attack (if needed)
        }
